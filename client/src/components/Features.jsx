...
const featuresData = [
  {
    icon: <MdOutlineCloudSync size={50} color="#4F46E5" />,
    title: "Cloud Sync",
    desc: [
  ...
  {
    icon: <LuFileLock2 size={50} color="#4F46E5" />,
  ...
  {
    icon: <MdOutlineImportantDevices size={50} color="#4F46E5" />,
  ...
  {
    icon: <MdColorLens size={50} color="#4F46E5" />,
    title: "Custom Themes",
    desc: [
